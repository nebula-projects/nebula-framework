...
public final class ReflectionUtils {
  ...
  public static final Method
      OBJECT_HASHCODE =
      getDeclaredMethod(Object.class, "hashCode", (Class[]) null);
  public static final Method
      OBJECT_TOSTRING =
      getDeclaredMethod(Object.class, "toString", (Class[]) null);
  public static final Method
      OBJECT_FINALIZE =
      getDeclaredMethod(Object.class, "finalize", (Class[]) null);
   ...
   * parameters. Searches all superclasses up to <code>Object</code>. <p> Returns <code>null</code>
   ...
   * types. Searches all superclasses up to <code>Object</code>. <p> Returns <code>null</code> if no
   * {@link Method} can be found.
   *
   * @param clazz      the class to introspect
   * @param name       the name of the method
   ...
   */
  private static boolean isMatchingConstructor(final Constructor<?> classConstructor,
                                               final Object... objs) {
  ...
  /**
   * Basically calls getDeclaredMethod on a Class but wraps the NoSuchMethodException into a
   * Runtime.
   *
   * @param clazz      class on which the getDeclaredMethod is called
